...
namespace DevPCI.Modules.DNN_Clones_Module_Manager_DevPCI_Clonator.Data
{
    ...
    public abstract class DataProvider
    {
        ...
        public static DataProvider Instance()
        {
            if (provider == null)
            {
                const string assembly = "DevPCI.Modules.DNN_Clones_Module_Manager_DevPCI_Clonator.Data.SqlDataprovider,DNN_Clones_Module_Manager_DevPCI_Clonator";
